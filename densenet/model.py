...
def readTXT(path):
    ...
    return wordLib
characters = readTXT("./densenet/chn_4646.txt")
...
# weights_densenet-08-2.46-260(2).h5    weights_densenet-05-2.61.h5    weights_densenet-03-0.90-320.h5
modelPath = os.path.join(os.getcwd(), 'densenet/models/weights_densenet-03-0.90-320.h5')  # weights_densenet.h5
